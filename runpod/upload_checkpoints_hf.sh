...
: "${HF_REPO_ID:?Set HF_REPO_ID, for example yourname/arc-124m-vl-checkpoints}"

ARC_VOL="${ARC_VOL:-/workspace}"
ARC_DATA_DIR="${ARC_DATA_DIR:-$ARC_VOL/arc_data}"
CHECKPOINT_DIR="${CHECKPOINT_DIR:-$ARC_DATA_DIR/checkpoints_stage1_20b}"
REMOTE_PATH="${REMOTE_PATH:-stage1}"
