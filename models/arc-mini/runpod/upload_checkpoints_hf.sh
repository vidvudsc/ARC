...
: "${HF_REPO_ID:?Set HF_REPO_ID, for example yourname/arc-mini-vl-checkpoints}"

ARC_VOL="${ARC_VOL:-/workspace}"
ARC_DATA_DIR="${ARC_DATA_DIR:-$ARC_VOL/arc_mini_data}"
CHECKPOINT_DIR="${CHECKPOINT_DIR:-$ARC_DATA_DIR/checkpoints_mini_mixed_1b}"
REMOTE_PATH="${REMOTE_PATH:-mini_mixed_1b}"
